...
#include<pcl-1.7/pcl/point_representation.h>
...
#include<pcl-1.7/pcl/registration/icp_nl.h>
...
{
  bool operator () (const PCD& p1, const PCD& p2)//运算符重载（）
  {
...
void loadData (int argc, char **argv, std::vector<PCD, Eigen::aligned_allocator<PCD> > &models)
{
  ...
  for (int i = 1; i < argc; i++)
  {
    ...
    std::transform (fname.begin (), fname.end (), fname.begin (), (int(*)(int))tolower);//小写
