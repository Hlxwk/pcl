...
class FeatureCloud
{
  public:
    // A bit of shorthand
    typedef pcl::PointCloud<pcl::PointXYZ> PointCloud;//点云
    typedef pcl::PointCloud<pcl::Normal> SurfaceNormals;//存储法线特征
    typedef pcl::PointCloud<pcl::FPFHSignature33> LocalFeatures;//存储fpfh特征
    typedef pcl::search::KdTree<pcl::PointXYZ> SearchMethod;//setSearchMethod
