...
main(int argc,char ** argv)
{
    ...
    std::cout<<"Setting angular resloution in x-direction to "<<angular_resolution_x<<"deg.\n";
    ...
    pcl::deg2rad(360.0f),pcl::deg2rad(180.0f),scene_sensor_pose,coordinate_frame,noise_level,min_range,border_size);
    ...
    while(!viewer.wasStopped())
    {
        ...
        if(live_update)
        {
            ...
            range_image.createFromPointCloud(point_cloud,angular_resolution_x,angular_resolution_y,
            pcl::deg2rad(360.0f),pcl::deg2rad(180.0f),scene_sensor_pose,pcl::RangeImage::LASER_FRAME,
